...
namespace DAL
{
    public class CV3360BQP_QN:  BaseDAL, UTL.IBaseDAL
    {
        ...
        /// <summary>
        /// BHYT ngoại Trú 3360 với số bệnh án
        /// </summary>
        /// <param name="to"></param>
        /// <param name="from"></param>
        /// <returns></returns>
        public DataTable Select_QN_With_BA_NgoaiTru(string mBA)
        {
            var sql = "SELECT ma_lk::integer,ho_ten,ngay_sinh,gioi_tinh,dia_chi,ma_the,ma_dkbd,gt_the_tu,gt_the_den,ma_benh,ma_benhkhac,ma_lydo_vvien,ma_noi_chuyen,ngay_vao::text,ngay_ra::text,so_ngay_dtri,ket_qua_dtri,tinh_trang_rv,t_tongchi,t_xn,t_cdha,t_thuoc,t_mau,t_pttt,t_vtyt,t_dvkt_tyle,t_thuoc_tyle,t_vtyt_tyle,t_kham,t_giuong,t_vanchuyen,t_bntt,t_bhtt,t_ngoaids,ma_khoa,nam_qt,thang_qt,ma_khuvuc,ma_loai_kcb,ma_cskcb from his_bhxh_3360_get_with_BA('{0}|1^3^4')";
            sql = string.Format(sql, mBA);
            return ExecuteQuery(sql);
        }
        /// <summary>
        /// BHYT Nội Trú 3360 với số bệnh án
        /// </summary>
        /// <param name="mBA"></param>
        /// <returns></returns>
        public DataTable Select_QN_With_BA_NoiTru(string mBA)
        {
            var sql = "SELECT ma_lk::integer,ho_ten,ngay_sinh,gioi_tinh,dia_chi,ma_the,ma_dkbd,gt_the_tu,gt_the_den,ma_benh,ma_benhkhac,ma_lydo_vvien,ma_noi_chuyen,ngay_vao::text,ngay_ra::text,so_ngay_dtri,ket_qua_dtri,tinh_trang_rv,t_tongchi,t_xn,t_cdha,t_thuoc,t_mau,t_pttt,t_vtyt,t_dvkt_tyle,t_thuoc_tyle,t_vtyt_tyle,t_kham,t_giuong,t_vanchuyen,t_bntt,t_bhtt,t_ngoaids,ma_khoa,nam_qt,thang_qt,ma_khuvuc,ma_loai_kcb,ma_cskcb from his_bhxh_3360_get_with_BA('{0}|2')";
            sql = string.Format(sql, mBA);
            return ExecuteQuery(sql);
        }
